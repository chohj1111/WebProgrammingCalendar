...
var FullCalendar = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    function compareByFieldSpec(obj0, obj1, fieldSpec) {
        ...
        return (
            flexibleCompare(obj0[fieldSpec.field], obj1[fieldSpec.field]) * (fieldSpec.order || 1)
        );
    }
    ...
    */
    ...
    function buildSegTimeText(
        ...
        if (displayEventTime && !eventDef.allDay && (seg.isStart || seg.isEnd)) {
            var segStart =
                startOverride ||
                (seg.isStart ? eventInstance.range.start : seg.start || seg.eventRange.range.start);
            var segEnd =
                endOverride ||
                (seg.isEnd ? eventInstance.range.end : seg.end || seg.eventRange.range.end);
    ...
    */
    ...
    var TimeColsSlatsCoords = /** @class */ (function () {
        ...
        TimeColsSlatsCoords.prototype.computeTimeTop = function (duration) {
            ...
            var slatCoverage =
                (duration.milliseconds - asRoughMs(dateProfile.slotMinTime)) / slotDurationMs;
            var slatIndex;
            var slatRemainder;
